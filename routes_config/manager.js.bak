...
module.exports = {
    ...
    "addUser": {
        ...
        routerOperate: [
            ...
            { key: "verify the password", args: ["{{#password}}"], showError: { error_code: ERROR_CODE.ERROR_BAD_PASSWORD, error_msg: "密码必须包括长度8位以上，包含字母、数字及特殊符号" } },
            { key: "修改密码新旧密码一致性校验", args: ["{{#name}}", "{{#old_password}}", "{{#password}}"], showError: { error_code: ERROR_CODE.ERROR_BAD_PASSWORD, error_msg: "原密码不正确" } },
            { key: "encrypt the password", fun: FLI.plug.encrypt.encode, args: ["{{#password}}", CONFIG.server_salt] },
    ...
    "getSIMCards": {
        filters: [FLI.plug.commonFilter.authenticationManage],
        routerOperate: [
            { key: "获取排序字段", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderProp}}", right: undefined, result: "d.bind_time", then: "{{#orderProp}}" }] },//create_time
            { key: "获取正逆排序关键字", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderAsc}}", right: true, result: "ASC", then: "DESC" }] },//DESC
            { key: "获取页码", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#current}}", right: undefined, result: undefined, then: "{{#current}}" }] },//DESC
            { key: "获取单页总数", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#size}}", right: undefined, result: undefined, then: "{{#size}}" }] },//DESC
    ...
    "getSIMCharge": {
        filters: [FLI.plug.commonFilter.authenticationManage],
        routerOperate: [
            { key: "获取排序字段", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderProp}}", right: undefined, result: "o.create_time", then: "{{#orderProp}}" }] },//create_time
            { key: "获取正逆排序关键字", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderAsc}}", right: true, result: "ASC", then: "DESC" }] },//DESC
            { key: "获取页码", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#current}}", right: undefined, result: undefined, then: "{{#current}}" }] },//DESC
            { key: "获取单页总数", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#size}}", right: undefined, result: undefined, then: "{{#size}}" }] },//DESC
    ...
    "getDeviceEvent": {
        filters: [FLI.plug.commonFilter.authenticationManage],
        routerOperate: [
            { key: "获取排序字段", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderProp}}", right: undefined, result: "de.create_time", then: "{{#orderProp}}" }] },//create_time
            { key: "获取正逆排序关键字", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#orderAsc}}", right: true, result: "ASC", then: "DESC" }] },//DESC
            { key: "获取页码", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#current}}", right: undefined, result: undefined, then: "{{#current}}" }] },//DESC
            { key: "获取单页总数", fun: FLI.plug.expression.ask, args: [{ symbol: "===", left: "{{#size}}", right: undefined, result: undefined, then: "{{#size}}" }] },//DESC
    ...
    "saveAppConfig": {
        filters: [FLI.plug.commonFilter.authenticationManage, "{{#yearCost}}", "{{#monthCost}}"]//"{{#activeCost}}", 
        ,
        routerOperate: [
